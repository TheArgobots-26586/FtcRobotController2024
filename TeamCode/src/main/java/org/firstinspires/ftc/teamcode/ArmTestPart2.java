...
@TeleOp(name="Arm Test Part 2", group="TeleOp")

public class ArmTestPart2 extends LinearOpMode {
    ...
    final double extended = 1300.0;
    final double unextended = 0.0;
    double extenderPosition = unextended;
    @Override
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //if x is pressed the arm should rest
                ...
                extenderPosition = extended;
            }
            else if(gamepad1.a) {
                extenderPosition = unextended;
            }
            ...
            extender.setTargetPosition((int)extenderPosition);
